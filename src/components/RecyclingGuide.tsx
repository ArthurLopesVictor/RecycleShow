...
// Define as cores das lixeiras de acordo com o padrão brasileiro
const binColors = {
...
// Componente educacional com guia completo de reciclagem
// Inclui 3 abas: Guia de itens, Curiosidades e Dicas práticas
export function RecyclingGuide() {
  const [searchTerm, setSearchTerm] = useState('');
  const [selectedCategory, setSelectedCategory] = useState<string | null>(null);

  // Pega todas as categorias únicas dos itens
  const categories = Array.from(new Set(recyclingGuide.map(item => item.category)));

  // Filtra o guia baseado na busca e na categoria selecionada
  ...
  return (
    <Tabs defaultValue="guide" className="space-y-6">
      ...
      <TabsContent value="guide" className="space-y-6">
        ...
        {/* Legenda das cores das lixeiras */}
        <Card>
          <CardHeader>
        ...
        {/* Grid com todos os itens do guia */}
          ...
          {filteredGuide.map((item, index) => (
            ...
            >
              <Card className="h-full hover:shadow-lg transition-shadow">
                {/* Faixa colorida no topo indicando a lixeira correta */}
                <div
                ...
                <CardHeader>
                  <div className="flex items-start justify-between">
                    ...
                    {/* Ícone de lixeira com a cor correspondente */}
                    <div
                ...
                <CardContent>
                  ...
                  {/* Lista de dicas para aquele item */}
                  ...
                  {/* Box indicando em qual lixeira colocar */}
        ...
        {/* Mensagem quando não encontra nada na busca */}
      ...
      <TabsContent value="curiosities" className="space-y-6">
        ...
        {/* Grid com os cards de curiosidades */}
      ...
      <TabsContent value="tips" className="space-y-6">
        ...
        {/* Como Separar em Casa (Secos, Úmidos, Rejeitos, Especiais) */}
        <Card>
          <CardHeader>
          ...
          <CardContent>
            <div className="space-y-6">
              ...
              {/* Box Amarelo: Explicação sobre Compostagem */}
              <div className="p-4 bg-yellow-50 rounded-lg border-l-4 border-yellow-600">
                ...
                {/* Seções explicando o processo de compostagem */}
        ...
        {/* Passo a Passo de Como Preparar Materiais */}
        <Card>
          <CardHeader>
          ...
          <CardContent>
            <div className="space-y-4">
              {/* Instruções específicas para cada tipo de material */}
              <div className="flex items-start gap-3">
